...
class MoveFileController implements RequestFilterInterface, RequestValidatorInterface, ControllerInterface
{
    ...
    public function filterRequest(ServerRequestInterface $request): ServerRequestInterface
    {
        ...
        return FilterService::filter($request, [
            'new_path' => $this->helper->getPathFilter(),
        ]);
    }
    ...
    public function validateRequest(ServerRequestInterface $request): void
    {
        ...
        ValidationService::validate($request, ['new_path' => $this->helper->getPathValidator()]);
    }
    ...
    public function execute(ServerRequestInterface $request) : ResponseInterface
    {
        ...
        $file->setPath(FilePathValue::get($body['new_path']));
